...
@section('content')
    ...
    <form method="GET" action="{{ route('books.index') }}" class="mb-4 flex items-center space-x-2">
        ...
        <input type="hidden" value="{{ request('filter') }}" />
        <button class="btn h-10" type="submit" class="btn">Search</button>
                    ...
                    <div class="flex flex-wrap items-center justify-between">
                        ...
                        <div>
                            ...
                            <div class="book-review-count">
                                out of {{ $book->reviews__count }} {{ Str::plural('review', $book->reviews__count) }}
                            </div>
                        </div>
                    </div>
                </div>
